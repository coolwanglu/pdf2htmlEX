...
void parse_options (int argc, char **argv)
{
    argparser
        ...
        .add("font-size-multiplier", &param.font_size_multiplier, 3.0, "setting a value greater than 1 would increase the rendering accuracy")
        .add("auto-hint", &param.auto_hint, 1, "[Experimental] Whether to generate hints for fonts")
